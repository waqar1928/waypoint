...
export const metadata: Metadata = {
  title: "AI Usage Disclosure — Waypoint",
  description: "How Waypoint Coach works, what it does with your data, and its real limitations.",
};
  ...
  return (
    <article>
      ...
      <p className="mt-6 text-sm text-ink-700">
        Waypoint Coach is the only AI feature in this product. This page describes, plainly and
      ...
      <p className="mt-3 text-sm text-ink-700">
        Waypoint Coach is powered by an AI language model (Anthropic&apos;s Claude). It is not a
      ...
      <p className="mt-3 text-sm text-ink-700">
        Like any AI language model, Waypoint Coach can be wrong, incomplete, or miss important
      ...
      <p className="mt-3 text-sm text-ink-700">
        Your Coach conversations are saved to your account (same as any other Waypoint content) so
