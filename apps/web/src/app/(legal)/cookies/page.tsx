...
export const metadata: Metadata = {
  title: "Cookie Policy | Drevia",
  description: "The complete list of cookies Drevia sets and why.",
};
  ...
  return (
    <article>
      ...
      <p className="mt-6 text-sm text-ink-700">
        This is the complete, actual list of cookies Drevia sets today. Every cookie this
        product uses anywhere is listed here, not a generic template list. There are exactly two,
        and both exist purely to make the product work. Neither is used for advertising or
        tracking.
      </p>
        ...
        <table className="w-full border-collapse text-left text-sm">
          ...
          <tbody className="text-ink-700">
            <tr className="border-b border-ink-100">
              <td className="py-3 pr-4 font-mono text-xs">drevia.auth</td>
            ...
            <tr>
              <td className="py-3 pr-4 font-mono text-xs">drevia.csrf</td>
