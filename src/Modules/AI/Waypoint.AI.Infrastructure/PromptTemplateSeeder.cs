...
/// <summary>
/// Seeds the versioned prompt templates Waypoint Coach runs on. Every prompt here is original
/// content authored for Waypoint — never sourced from or written to imitate any specific book or
...
internal static class PromptTemplateSeeder
{
    private const string CommonVoiceRules =
        ...
        "personal brand — everything you say is original Waypoint coaching in Waypoint's own voice. " +
    ...
    [
        (
            "coach.v1",
            1,
            "You are Waypoint Coach, the guide inside Waypoint — an original tool that helps people turn " +
        ...
        (
            "dream-analysis.v1",
            1,
            "You are Waypoint Coach, looking at someone's Dream Statement with them. Reflect back what's " +
        ...
        (
            ...
            1,
            "You are Waypoint Coach in \"Challenge My Idea\" mode — the user has asked you to stress-test " +
