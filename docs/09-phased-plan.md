...
| 12. Production deployment | CI/CD, environment hardening, observability rollout | **First formal pass done** (CI/CD, hardening, logging) — Dockerfiles + live deploy intentionally deferred, see `docs/13-production-readiness-phase12.md` |
